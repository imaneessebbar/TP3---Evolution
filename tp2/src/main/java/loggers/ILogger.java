...
/**
 * an ILogger interface that plays the behavior role of Handler in the Chain of
 * Responsibility Design pattern.<br/>
 * It provides an interface for a logger that must either handle a logging
 * request, if it can, or forward it to its successor in the chain of
 * responsibility;
 * 
 * @author anonbnr
 *
